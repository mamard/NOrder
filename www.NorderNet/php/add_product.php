	...
	<!-- Select methode -->
		<form action="" id="add_product_method">
			...
			<div class="add_product_method_grid">
				<!-- Scan produit -->
				<div class="add_product_method_scan add_product_style_button"><img id="scan_picture" alt="scan"  class="add_product_method_scan" height="40" src="picture/scan2.png"/></div>
				<div class="add_product_method_scan_text">Scanner avec smartphone</div>
				<!-- Ou -->
				<div class="add_product_method_or">ou</div>
				<!-- Ajout manuel -->	
				<a href="#add_product_manual" class="add_product_method_manual add_product_style_button">saisie<br>manuelle</a>
